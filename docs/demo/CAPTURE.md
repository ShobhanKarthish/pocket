...
Empty stills were recaptured after docking **Add items** + **How to add** in the Scaffold bottom bar (~28 dp above the 48 dp nav inset). Shelf was already empty. Re-seed is not in git.
